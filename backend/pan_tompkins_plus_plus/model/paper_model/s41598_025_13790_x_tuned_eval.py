...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate the tuned CatBoost variant found on the reconstructed heart-disease dataset.")
    ...
    result = {
        ...
        "method": "global_label_encode_impute + lasso_selected_features + global_random_oversampling + 80_20_holdout + tuned_catboost",
        ...
        "metrics": evaluate(y_test, proba, TUNED_THRESHOLD),
    }

    print(json.dumps(result, indent=2))

    output_json = args.output_json or (paper_dir / "s41598_025_13790_x_tuned_best_result.json")
